    ...
    public static class DbSeeder
    {
        ...
        private static async Task SeedParametersAsync(GymContext context)
        {
            ...
            var parameters = new[]
            {
                ...
                // Admin dashboard
                new Parameter { Name = "Admin.Dashboard.PageTitle", Value = "Dashboard", Description = "Admin dashboard page title", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.ActiveMembers", Value = "Members (active)", Description = "Active members card label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.TotalMembers", Value = "Total members", Description = "Total members card label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.ActiveMemberships", Value = "Active memberships", Description = "Active memberships card label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.ExpiringSoon", Value = "Expiring in 7 days", Description = "Expiring memberships card label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.TodayBookings", Value = "Bookings (today)", Description = "Today bookings card label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.TodayCancellations", Value = "Cancellations today", Description = "Today cancellations card label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.CmsContent", Value = "CMS content", Description = "CMS content card label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Pages", Value = "Pages", Description = "CMS pages label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.UpcomingClasses", Value = "Upcoming classes", Description = "Upcoming classes panel title", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Today", Value = "Today", Description = "Today badge label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Class", Value = "Class", Description = "Class table header", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Start", Value = "Start", Description = "Start table header", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Room", Value = "Room", Description = "Room table header", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Capacity", Value = "Capacity", Description = "Capacity table header", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Bookings", Value = "Bookings", Description = "Bookings table header", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Status", Value = "Status", Description = "Status table header", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Full", Value = "Full", Description = "Full class status", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.Open", Value = "Open", Description = "Open class status", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.NoClassesToday", Value = "No classes scheduled for today.", Description = "Empty classes table text", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.CapacityTip", Value = "Tip: capacity is based on FitnessClass.Capacity and bookings count.", Description = "Capacity explanation text", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.ViewFullSchedule", Value = "View full schedule", Description = "Full schedule button label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.QuickActions", Value = "Quick actions", Description = "Quick actions title", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.AddMember", Value = "Add member", Description = "Add member button label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.CreateMembershipPlan", Value = "Create membership plan", Description = "Create membership plan button label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.AddClass", Value = "Add class to schedule", Description = "Add class button label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.PostAnnouncement", Value = "Post announcement", Description = "Post announcement button label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.EditParameters", Value = "Edit parameters (CMS)", Description = "Edit parameters button label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                new Parameter { Name = "Admin.Dashboard.EditPortalPages", Value = "Edit portal pages (CMS)", Description = "Edit portal pages button label", ParameterCategoryId = adminDashboardCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder", ModifiedAt = now, ModifiedBy = "Seeder" },
                // bookings
                new Parameter { Name = "Bookings.Title", Value = "My bookings", ParameterCategoryId = bookingsCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder" },
                new Parameter { Name = "Bookings.BackToSchedule", Value = "Back to schedule", ParameterCategoryId = bookingsCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder" },
                new Parameter { Name = "Bookings.Class", Value = "Class", ParameterCategoryId = bookingsCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder" },
                new Parameter { Name = "Bookings.Date", Value = "Date", ParameterCategoryId = bookingsCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder" },
                new Parameter { Name = "Bookings.Room", Value = "Room", ParameterCategoryId = bookingsCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder" },
                new Parameter { Name = "Bookings.Status", Value = "Status", ParameterCategoryId = bookingsCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder" },
                new Parameter { Name = "Bookings.Actions", Value = "Actions", ParameterCategoryId = bookingsCategoryId, IsActive = true, CreatedAt = now, CreatedBy = "Seeder" },
